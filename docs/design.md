...
| `AVATAR_CHARACTER` | アバターキャラクター（例: `lisa`） | — |
| `AVATAR_STYLE` | アバタースタイル（例: `casual-sitting`） | — |
| `AVATAR_VOICE` | 音声名（例: `ja-JP-NanamiNeural`） | — |
